        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="/users" class="waves-effect"><i class="mdi mdi-account-box"></i><span> Users </span></a>
                    </li>

                    <li>
                        <a href="/restaurants" class="waves-effect"><i class="mdi mdi-clipboard-outline"></i><span> Restaurants </span></a>
                    </li>

                    <li>
                        <a href="/AdminProduits" class="waves-effect"><i class="mdi mdi-clipboard-outline"></i><span> Plats </span></a>
                    </li>

                    <li>
                        <a href="/AdminCommandes" class="waves-effect"><i class="mdi mdi-calendar-clock"></i><span> Commandes </span></a>
                    </li>

                    <li>
                        <a href="/AdminCommentaires" class="waves-effect"><i class="mdi mdi-border-color"></i><span> Commentaires </span></a>
                    </li>

                    <li>
                        <a href="/sitemap" class="waves-effect"><i class="mdi mdi-google-maps"></i><span> SiteMap </span></a>
                    </li>
